...
final class Core
{
    ...
    public function bootstrap()
    {
        ...
        try {
            ...
            $dispatcher->setApp($this->router->getParam('app') ?? 'Core');
            $dispatcher->setController($this->router->getParam('controller') ?? 'Index');
            $dispatcher->setAction($this->router->getParam('action') ?? 'Index');
