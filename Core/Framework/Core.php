...
final class Core
{
    ...
    public function bootstrap()
    {
        ...
        try {
            ...
            $dispatcher->setApp($this->router->getTarget('app') ?? 'Core');
            $dispatcher->setController($this->router->getTarget('controller') ?? 'Index');
            $dispatcher->setAction($this->router->getTarget('action') ?? 'Index');
