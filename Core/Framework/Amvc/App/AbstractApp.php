...
abstract class AbstractApp
{
    ...
    protected function initCss()
    {
        ...
        if (! self::$init_stages[$this->name]['css'] && $this->paths->exists('dir.assets')) {
            ...
            $filename = $this->paths->get('dir.assets') . DIRECTORY_SEPARATOR . 'Css' . DIRECTORY_SEPARATOR . $this->name . '.css';
            
            if (file_exists($filename)) {
                $this->css->link($this->paths->get('url.assets') . DIRECTORY_SEPARATOR . 'Css' . DIRECTORY_SEPARATOR . $this->name . '.css');
            }
    ...
    protected function initJs()
    {
        if (! self::$init_stages[$this->name]['js'] && $this->paths->exists('dir.assets')) {
            ...
            $filename = $this->paths->get('dir.assets') . DIRECTORY_SEPARATOR . 'Js' . DIRECTORY_SEPARATOR . $this->name . '.js';
            
            if (file_exists($filename)) {
                $this->javascript->file($this->paths->get('url.assets') . DIRECTORY_SEPARATOR . 'Js' . DIRECTORY_SEPARATOR . $this->name . '.js');
            }
